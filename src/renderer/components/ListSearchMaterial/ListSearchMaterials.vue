<template >
  <el-row>  
    ...
    <el-row>
      <el-col :offset="6">
        <el-pagination v-if="totalmisMat > 0" @current-change="changePage" :page-size="20" :pager-count="11" layout="prev, pager, next" :total="totalmisMat"></el-pagination>
      </el-col>
    </el-row>
  </el-row>
</template>
  ...
  components: { Card,CardClassic },
   ...
   console.log(misMat);
    return {
      ...
      tipoMaterial:this.$route.params.titulo,
