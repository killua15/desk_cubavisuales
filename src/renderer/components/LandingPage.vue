<template>
  <div id="wrapper">
    <menu-nav :data="tablasImportant"></menu-nav>
    <main>
      <list-material :data="tablasImportant"></list-material>
    </main>
  </div>
</template>
<script>
import MenuNav from "./LandingPage/MenuNav";
import ListMaterial from "./LandingPage/ListMaterial";
import JsonMaterial from "../store/json/cubavisu_db.json";
export default {
  name: "landing-page",
  components: { MenuNav, ListMaterial },
  data() {
   ...
   // console.log(tablasImportant);
    return {tablasImportant}
  },
  methods: {
    cargarData() {}
  }
